...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pQuad->LoadMesh("C:/Users/79649/dev/projects/Content/quad.obj")) {
            return false;
        }

        m_pMesh = new Mesh();

        return m_pMesh->LoadMesh("C:/Users/79649/dev/projects/Content/phoenix_ugv.md2");
    }
...
int main(int argc, char** argv)
{
    ...
    Magick::InitializeMagick(nullptr); // <--- добавляем эту линию
